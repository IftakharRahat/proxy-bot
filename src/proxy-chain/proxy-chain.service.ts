...
export class ProxyChainService implements OnModuleInit {
    ...
    constructor(
        ...
        // Use an aggressive sequence to ensure ghost processes are killed before restart
        this.reloadCommand = this.configService.get<string>('PROXY_RELOAD_COMMAND') || 'systemctl stop 3proxy; killall -9 3proxy; systemctl start 3proxy';
    }
    ...
    async rebuildConfig() {
        ...
        // 2. Start config content - SIMPLE VERSION
