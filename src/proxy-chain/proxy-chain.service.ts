...
export class ProxyChainService implements OnModuleInit {
    ...
    constructor(
        ...
        // Using restart as it's more reliable
        this.reloadCommand = this.configService.get<string>('PROXY_RELOAD_COMMAND') || 'systemctl restart 3proxy';
    }
    ...
    async rebuildConfig() {
        ...
        // 2. Start config content (Removing daemon mode for systemd compatibility)
...
`;
        ...
        this.logger.log('Generated 3proxy config:\n' + config);
